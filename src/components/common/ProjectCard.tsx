...
export function ProjectCard({ project, cardBgClass = "bg-surface-alt" }: ProjectCardProps) {
  ...
  const cardContent = (
    <>
      ...
      <div className={`mt-4 sm:mt-6 flex items-center ${url ? "justify-between" : "justify-end"}`}>
        {url && <ArrowUpRight className="shrink-0 text-accent" />}
        {project.year && (
  ...
  const cardClasses = `w-[280px] min-[375px]:w-[320px] min-[480px]:w-[360px] min-[577px]:w-[420px] md:w-[480px] lg:w-[520px] shrink-0 snap-start rounded-[20px] p-6 min-[375px]:p-7 sm:p-9 h-[360px] min-[375px]:h-[380px] sm:h-[350px] min-h-[360px] min-[375px]:min-h-[380px] sm:min-h-[350px] flex flex-col justify-between apple-card-hover ${cardBgClass}`
